# Python_Projects_Data-Science_A_2_Z
...
now take just 1(one) variable x1 & it's slope represented by b1.
More detail 》 how we play with Ridge L1 & L2 :: & in forecasting business in Boston dataset !
refer to the hyperlink 》 from AI (Gemini) 💕
